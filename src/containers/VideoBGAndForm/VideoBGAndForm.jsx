  ...
  const getSubmitForm = () => {
    return (
      <div className="header-queryBox" style={{ flexGrow: 3 }}>
        <BoxText fontWeight="700" fontSize="20px" lineHeight="24px" textAlign="center" width="100%">GET YOUR QUESTIONS ANSWERED</BoxText>
        <BoxText fontWeight="600" fontSize="14px" lineHeight="17px" textAlign="center" width="100%">What degree level are you interested in pursuing?</BoxText>
        <form action="#" style={{ width: "100%" }}>
          <div className="header-queryBox_form">
            ...
            <Container>
              <div className="header-queryBox_field" style={{ marginRight: "10px" }}>
                First name
                <input type="text" id="fname" name="fname"/>
              </div>
              <div className="header-queryBox_field" style={{ marginLeft: "10px" }}>
                Last name
            ...
            <Container alignItems="end">
              ...
              <div className="header-queryBox_submit" style={{ marginLeft: "10px" }}>
              <input type="submit" value="Submit" />
              </div>
            </Container>
          </div>
        </form>
        <BoxText fontWeight="500" fontSize="9px" lineHeight="11px" textAlign="center" width="100%" letterSpacing="-0.02em">We value your privacy and will never share this information without
          your consent.</BoxText>
      </div>
    );
  };
  const getDesktopTop=()=>{
